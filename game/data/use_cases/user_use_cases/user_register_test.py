from game.infra.db.repositories.class_repository.class_repository_mock import ClassRepositoryMock
...
def test_user_register_use_case():
    user_register_use_case = UserRegisterUseCase(user_use_case=users_repository, class_user_case=class_repository)
