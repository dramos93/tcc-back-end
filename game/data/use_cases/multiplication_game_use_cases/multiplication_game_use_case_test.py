import pytest
from game.data.use_cases.multiplication_game_use_cases.multiplication_game_use_cases import MultiplicationGameUseCase
from game.infra.db.repositories.multiplication_game_repository.multiplication_game_repository_mock import MultiplicationGameRepositoryFake
