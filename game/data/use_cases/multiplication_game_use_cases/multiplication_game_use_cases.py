...
from game.data.interfaces.multiplication_game_repository_interface import MultiplicationGameRepositoryInterface
from game.domain.models.multiplication_game_model import MultiplicationGameModel
from game.domain.user_cases.multiplication_game.multiplication_game_interface import MultiplicationGameInterface

class MultiplicationGameUseCase(MultiplicationGameInterface):
    def __init__(self, multiplication_game_repository: MultiplicationGameRepositoryInterface) -> None:
    ...
    def get_multiplication_game(self, user_id: int, class_id: int) -> List[Dict]:
        ...
        multiplicadion_games = self.multiplication_game_repository.get_all(user_id=user_id, class_id=class_id)
    ...
    @classmethod
    def __ajust_response(cls, multiplicadion_games: List[MultiplicationGameModel]) -> List[Dict]:
        response = []
