...
from game.domain.user_cases.authentication.authentication_interface import AuthenticationUserCaseInterface

class AuthenticationUseCases(AuthenticationUserCaseInterface):
    def __init__(self, authentication_repository: AuthenticationRepositoryInterface, user_repository: UsersRepositoryInterface) -> None:
    ...
    def get_token(self, user_id: int) -> Dict:
        self.__user_exists(user_id=user_id)
        authentication_repository = self.authentication_repository.get_token(user_id=user_id)
