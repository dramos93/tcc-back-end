...
from game.infra.db.repositories import class_repository
...
def get_classes_composer():
    ...
    classes_contoller = ClassesController(
        use_case=classes_use_case, auth_use_case=authentication_use_cases
    )
    return classes_contoller.get_classes