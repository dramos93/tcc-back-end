import pytest
from game.infra.db.repositories.multiplication_game_repository.multiplication_game_repository import MultiplicationGameRepository
...
def test_get_all_from_multiplication_game_table():
    multiplication_game_repository = MultiplicationGameRepository()
    data = multiplication_game_repository.get_all(user_id=sample_entity["user_id"], class_id=sample_entity["class_id"])
